...
//    private Thread pathThread;
    ...
    public void runOpMode() {
        ...
        try {
            ...
            autoDriving.setDefaultErrorRanges(new MovementData(0, 6000, Angle.fromDegrees(0, false)));

            while (opModeIsActive() && !isStopRequested()) {
                //frontLeftMotor.setPower(.29);
//                autoDriving.setStartLocation(0,0,0);
//                autoDriving.setDefaultErrorRanges(50,100,7);
	            autoDriving.stopAt(new MovementData(1500, 0, Angle.fromDegrees( 0, false)), 0.9);
