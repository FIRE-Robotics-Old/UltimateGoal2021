...
cv.createTrackbar('R Max', 'Color Window', 209, 255, empty)
cv.createTrackbar('G Min', 'Color Window', 160, 255, empty)
cv.createTrackbar('G Max', 'Color Window', 255, 255, empty)
cv.createTrackbar('B Min', 'Color Window', 0, 255, empty)
cv.createTrackbar('B Max', 'Color Window', 126, 255, empty)

img_original = cv.imread('ring_pic.jpg', 1)
